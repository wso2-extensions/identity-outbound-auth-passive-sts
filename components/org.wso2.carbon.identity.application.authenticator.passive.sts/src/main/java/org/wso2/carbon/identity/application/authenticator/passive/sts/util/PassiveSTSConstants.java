...
public class PassiveSTSConstants {
    ...
    public static final String HTTP_PARAM_PASSIVE_STS_LOGOUT = "logOutKey";
    public static final String HTTP_PARAM_PASSIVE_STS_WSIGNOUT = "wsignout1.0";
    public static final String REALM_ID = "RealmId";
    public static final String PASSIVE_STS_CALL_BACK_URL = "callBackUrl";
